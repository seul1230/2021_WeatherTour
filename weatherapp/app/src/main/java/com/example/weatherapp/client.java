...
public class client extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message1Text = (EditText) findViewById(R.id.messageText1);
        message2Text = (EditText) findViewById(R.id.messageText2);
        //connect 버튼 클릭
        connectBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyClientTask myClientTask = new MyClientTask("localhost", 12000, message1Text.getText().toString(),message2Text.getText().toString());
